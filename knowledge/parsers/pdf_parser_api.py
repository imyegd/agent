...
if __name__ == "__main__":
    ...
    papers_dir = "knowledge/data/papers"
    output_dir = "knowledge/parsers/parser_output"
        ...
        for i, filename in enumerate(pdf_files, 1):
            ...
            if text:
                ...
                with open(output_path, 'w', encoding='utf-8') as f:
                    f.write(text)
                print(f"解析完成，输出: {output_filename}")
                print(f"前20字符: {text[:20]}")
            else:
                print("解析失败或无内容，跳过。")
