...
class Config:
    ...
    # 本地模型路径配置
    LOCAL_EMBEDDING_MODEL_PATH = os.getenv('LOCAL_EMBEDDING_MODEL_PATH', 'Qwen/Qwen3-Embedding-0.6B')
    ...
    @classmethod
    def get_local_embedding_config(cls):
        """获取本地 Embedding 模型配置"""
        return {
            'model_path': cls.LOCAL_EMBEDDING_MODEL_PATH
        }
